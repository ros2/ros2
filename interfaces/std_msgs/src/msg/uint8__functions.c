...
// std_msgs/msg/UInt8 functions implementation
...
std_msgs__msg__UInt8 * std_msgs__msg__UInt8__create(void)
{
  ...
  std_msgs__msg__UInt8 * msg = (std_msgs__msg__UInt8 *)allocator.allocate(
    sizeof(std_msgs__msg__UInt8), allocator.state);
  if (!msg) { return NULL; }
  if (!std_msgs__msg__UInt8__init(msg)) {
  ...
  std_msgs__msg__UInt8__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (std_msgs__msg__UInt8 *)allocator.zero_allocate(
      size, sizeof(std_msgs__msg__UInt8), allocator.state);
