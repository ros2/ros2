...
// Version: v5-lite-c - Add field.name = "data"
//
// Testing if setting field name causes the crash
...
static void std_msgs_String_do_init(void) {
  fprintf(stderr, "[std_msgs/String] v5-lite-c: Starting...\n");
  ...
  if (!rosidl_runtime_c__String__assign(
    ...
    fprintf(stderr, "[std_msgs/String] v5-lite-c: Failed to assign type_name\n");
    return;
  }
  ...
  if (!rosidl_runtime_c__type_description__Field__Sequence__init(
    ...
    fprintf(stderr, "[std_msgs/String] v5-lite-c: Failed to init fields sequence\n");
    return;
  }
  ...
  if (!rosidl_runtime_c__String__assign(&field->name, "data")) {
    fprintf(stderr, "[std_msgs/String] v5-lite-c: Failed to assign field name\n");
    return;
  }
  ...
  if (!rosidl_runtime_c__type_description__IndividualTypeDescription__Sequence__init(
    ...
    fprintf(stderr, "[std_msgs/String] v5-lite-c: Failed to init referenced_type_descriptions\n");
    return;
  }
  ...
  g_init_success = 1;
  fprintf(stderr, "[std_msgs/String] v5-lite-c: OK - field[0].name='%s', type_id=%u\n",
