...
// geometry_msgs/msg/Inertia functions implementation
...
bool geometry_msgs__msg__Inertia__init(geometry_msgs__msg__Inertia * msg)
{
  if (!msg) { return false; }
  msg->m = 0.0;
  if (!geometry_msgs__msg__Vector3__init(&msg->com)) { return false; }
  msg->ixx = 0.0;
  msg->ixy = 0.0;
  msg->ixz = 0.0;
  msg->iyy = 0.0;
...
geometry_msgs__msg__Inertia * geometry_msgs__msg__Inertia__create(void)
{
  ...
  geometry_msgs__msg__Inertia * msg =
    (geometry_msgs__msg__Inertia *)allocator.allocate(
      sizeof(geometry_msgs__msg__Inertia), allocator.state);
  if (!msg) { return NULL; }
  if (!geometry_msgs__msg__Inertia__init(msg)) {
  ...
  geometry_msgs__msg__Inertia__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (geometry_msgs__msg__Inertia *)allocator.zero_allocate(
      size, sizeof(geometry_msgs__msg__Inertia), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__Inertia__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          geometry_msgs__msg__Inertia__fini(&array->data[j]);
        }
