...
// rcl_interfaces visibility control
...
#if defined(_WIN32)
  #if defined(ROSIDL_GENERATOR_C_BUILDING_DLL_rcl_interfaces)
    #define ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces __declspec(dllexport)
  #else
    #define ROSIDL_GENERATOR_C_PUBLIC_rcl_interfaces __declspec(dllimport)
  #endif
#else
