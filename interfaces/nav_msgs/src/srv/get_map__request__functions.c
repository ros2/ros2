...
// nav_msgs/srv/GetMap_Request functions
...
nav_msgs__srv__GetMap_Request * nav_msgs__srv__GetMap_Request__create(void)
{
  ...
  nav_msgs__srv__GetMap_Request * msg = (nav_msgs__srv__GetMap_Request *)allocator.allocate(
    sizeof(nav_msgs__srv__GetMap_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  if (!nav_msgs__srv__GetMap_Request__init(msg)) {
  ...
  nav_msgs__srv__GetMap_Request__Sequence * array, size_t size)
{
  ...
  array->data = (nav_msgs__srv__GetMap_Request *)allocator.zero_allocate(
    size, sizeof(nav_msgs__srv__GetMap_Request), allocator.state);
  if (!array->data) {
    return false;
  }

  for (size_t i = 0; i < size; ++i) {
    if (!nav_msgs__srv__GetMap_Request__init(&array->data[i])) {
      for (size_t j = 0; j < i; ++j) {
        nav_msgs__srv__GetMap_Request__fini(&array->data[j]);
      }
