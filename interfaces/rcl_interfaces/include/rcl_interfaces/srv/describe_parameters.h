...
// rcl_interfaces/srv/DescribeParameters type

#ifndef RCL_INTERFACES__SRV__DESCRIBEPARAMETERS_H_
#define RCL_INTERFACES__SRV__DESCRIBEPARAMETERS_H_
...
typedef struct rcl_interfaces__srv__DescribeParameters__Request
{
  rosidl_runtime_c__String__Sequence names;
} rcl_interfaces__srv__DescribeParameters__Request;

typedef struct rcl_interfaces__srv__DescribeParameters__Request__Sequence
{
  rcl_interfaces__srv__DescribeParameters__Request * data;
  size_t size;
  size_t capacity;
} rcl_interfaces__srv__DescribeParameters__Request__Sequence;
...
typedef struct rcl_interfaces__srv__DescribeParameters__Response
{
  rcl_interfaces__msg__ParameterDescriptor__Sequence descriptors;
} rcl_interfaces__srv__DescribeParameters__Response;

typedef struct rcl_interfaces__srv__DescribeParameters__Response__Sequence
{
  rcl_interfaces__srv__DescribeParameters__Response * data;
  size_t size;
  size_t capacity;
} rcl_interfaces__srv__DescribeParameters__Response__Sequence;
...
#endif  // RCL_INTERFACES__SRV__DESCRIBEPARAMETERS_H_
