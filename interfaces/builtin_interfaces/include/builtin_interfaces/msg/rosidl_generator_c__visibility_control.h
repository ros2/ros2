...
// Visibility control for builtin_interfaces
...
#if defined(_WIN32)
  #if defined(ROSIDL_GENERATOR_C_BUILDING_DLL_builtin_interfaces)
    #define ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces __declspec(dllexport)
  #else
    #define ROSIDL_GENERATOR_C_PUBLIC_builtin_interfaces __declspec(dllimport)
  #endif
#else
