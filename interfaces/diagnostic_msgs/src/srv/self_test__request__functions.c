...
// diagnostic_msgs/srv/SelfTest_Request functions
...
diagnostic_msgs__srv__SelfTest_Request * diagnostic_msgs__srv__SelfTest_Request__create(void)
{
  ...
  diagnostic_msgs__srv__SelfTest_Request * msg = (diagnostic_msgs__srv__SelfTest_Request *)allocator.allocate(
    sizeof(diagnostic_msgs__srv__SelfTest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  if (!diagnostic_msgs__srv__SelfTest_Request__init(msg)) {
  ...
  diagnostic_msgs__srv__SelfTest_Request__Sequence * array, size_t size)
{
  ...
  array->data = (diagnostic_msgs__srv__SelfTest_Request *)allocator.zero_allocate(
    size, sizeof(diagnostic_msgs__srv__SelfTest_Request), allocator.state);
  if (!array->data) {
    return false;
  }

  for (size_t i = 0; i < size; ++i) {
    if (!diagnostic_msgs__srv__SelfTest_Request__init(&array->data[i])) {
      for (size_t j = 0; j < i; ++j) {
        diagnostic_msgs__srv__SelfTest_Request__fini(&array->data[j]);
      }
