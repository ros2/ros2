...
#include "action_msgs/msg/detail/goal_status_array__rosidl_typesupport_introspection_cpp.hpp"
...
{
  return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_msgs, msg, GoalStatusArray)();
}
