...
// std_msgs/msg/Int8MultiArray functions implementation
...
std_msgs__msg__Int8MultiArray * std_msgs__msg__Int8MultiArray__create(void)
{
  ...
  std_msgs__msg__Int8MultiArray * msg =
    (std_msgs__msg__Int8MultiArray *)allocator.allocate(
      sizeof(std_msgs__msg__Int8MultiArray), allocator.state);
  if (!msg) { return NULL; }
  if (!std_msgs__msg__Int8MultiArray__init(msg)) {
  ...
  std_msgs__msg__Int8MultiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    array->data = (std_msgs__msg__Int8MultiArray *)allocator.zero_allocate(
      size, sizeof(std_msgs__msg__Int8MultiArray), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!std_msgs__msg__Int8MultiArray__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          std_msgs__msg__Int8MultiArray__fini(&array->data[j]);
        }
