...
#if defined(_WIN32)
  #if defined(ROSIDL_GENERATOR_C_BUILDING_DLL_shape_msgs)
    #define ROSIDL_GENERATOR_C_PUBLIC_shape_msgs __declspec(dllexport)
  #else
    #define ROSIDL_GENERATOR_C_PUBLIC_shape_msgs __declspec(dllimport)
  #endif
#else
