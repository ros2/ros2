...
// geometry_msgs/msg/Wrench functions implementation
...
{
  if (!msg) { return false; }
  if (!geometry_msgs__msg__Vector3__init(&msg->force)) { return false; }
  if (!geometry_msgs__msg__Vector3__init(&msg->torque)) { return false; }
  return true;
}
...
geometry_msgs__msg__Wrench * geometry_msgs__msg__Wrench__create(void)
{
  ...
  geometry_msgs__msg__Wrench * msg =
    (geometry_msgs__msg__Wrench *)allocator.allocate(
      sizeof(geometry_msgs__msg__Wrench), allocator.state);
  if (!msg) { return NULL; }
  if (!geometry_msgs__msg__Wrench__init(msg)) {
  ...
  geometry_msgs__msg__Wrench__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (geometry_msgs__msg__Wrench *)allocator.zero_allocate(
      size, sizeof(geometry_msgs__msg__Wrench), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__Wrench__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          geometry_msgs__msg__Wrench__fini(&array->data[j]);
        }
