...
// sensor_msgs/msg/CompressedImage functions implementation
...
bool sensor_msgs__msg__CompressedImage__init(sensor_msgs__msg__CompressedImage * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->format)) { return false; }
...
sensor_msgs__msg__CompressedImage * sensor_msgs__msg__CompressedImage__create(void)
{
  ...
  sensor_msgs__msg__CompressedImage * msg =
    (sensor_msgs__msg__CompressedImage *)allocator.allocate(
      sizeof(sensor_msgs__msg__CompressedImage), allocator.state);
  if (!msg) { return NULL; }
  if (!sensor_msgs__msg__CompressedImage__init(msg)) {
  ...
  sensor_msgs__msg__CompressedImage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (sensor_msgs__msg__CompressedImage *)allocator.zero_allocate(
      size, sizeof(sensor_msgs__msg__CompressedImage), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!sensor_msgs__msg__CompressedImage__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          sensor_msgs__msg__CompressedImage__fini(&array->data[j]);
        }
