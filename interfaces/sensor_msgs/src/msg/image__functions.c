...
// sensor_msgs/msg/Image functions implementation
...
bool sensor_msgs__msg__Image__init(sensor_msgs__msg__Image * msg)
{
  ...
  msg->height = 0;
  msg->width = 0;
  if (!rosidl_runtime_c__String__init(&msg->encoding)) { return false; }
  msg->is_bigendian = 0;
  msg->step = 0;
...
sensor_msgs__msg__Image * sensor_msgs__msg__Image__create(void)
{
  ...
  sensor_msgs__msg__Image * msg =
    (sensor_msgs__msg__Image *)allocator.allocate(
      sizeof(sensor_msgs__msg__Image), allocator.state);
  if (!msg) { return NULL; }
  if (!sensor_msgs__msg__Image__init(msg)) {
  ...
  sensor_msgs__msg__Image__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (sensor_msgs__msg__Image *)allocator.zero_allocate(
      size, sizeof(sensor_msgs__msg__Image), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!sensor_msgs__msg__Image__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          sensor_msgs__msg__Image__fini(&array->data[j]);
        }
