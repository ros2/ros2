...
// geometry_msgs/msg/Vector3Stamped functions implementation
...
bool geometry_msgs__msg__Vector3Stamped__init(geometry_msgs__msg__Vector3Stamped * msg)
{
  ...
  if (!geometry_msgs__msg__Vector3__init(&msg->vector3)) {
...
void geometry_msgs__msg__Vector3Stamped__fini(geometry_msgs__msg__Vector3Stamped * msg)
{
  ...
  geometry_msgs__msg__Vector3__fini(&msg->vector3);
}
...
geometry_msgs__msg__Vector3Stamped * geometry_msgs__msg__Vector3Stamped__create(void)
{
  ...
  geometry_msgs__msg__Vector3Stamped * msg =
    (geometry_msgs__msg__Vector3Stamped *)allocator.allocate(
      sizeof(geometry_msgs__msg__Vector3Stamped), allocator.state);
  if (!msg) { return NULL; }
  if (!geometry_msgs__msg__Vector3Stamped__init(msg)) {
  ...
  geometry_msgs__msg__Vector3Stamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (geometry_msgs__msg__Vector3Stamped *)allocator.zero_allocate(
      size, sizeof(geometry_msgs__msg__Vector3Stamped), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__Vector3Stamped__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          geometry_msgs__msg__Vector3Stamped__fini(&array->data[j]);
        }
