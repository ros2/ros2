...
// sensor_msgs/msg/FluidPressure functions implementation
...
sensor_msgs__msg__FluidPressure * sensor_msgs__msg__FluidPressure__create(void)
{
  ...
  sensor_msgs__msg__FluidPressure * msg =
    (sensor_msgs__msg__FluidPressure *)allocator.allocate(
      sizeof(sensor_msgs__msg__FluidPressure), allocator.state);
  if (!msg) { return NULL; }
  if (!sensor_msgs__msg__FluidPressure__init(msg)) {
  ...
  sensor_msgs__msg__FluidPressure__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (sensor_msgs__msg__FluidPressure *)allocator.zero_allocate(
      size, sizeof(sensor_msgs__msg__FluidPressure), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!sensor_msgs__msg__FluidPressure__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          sensor_msgs__msg__FluidPressure__fini(&array->data[j]);
        }
