...
// std_msgs/msg/MultiArrayLayout functions implementation
...
std_msgs__msg__MultiArrayLayout * std_msgs__msg__MultiArrayLayout__create(void)
{
  ...
  std_msgs__msg__MultiArrayLayout * msg =
    (std_msgs__msg__MultiArrayLayout *)allocator.allocate(
      sizeof(std_msgs__msg__MultiArrayLayout), allocator.state);
  if (!msg) { return NULL; }
  if (!std_msgs__msg__MultiArrayLayout__init(msg)) {
  ...
  std_msgs__msg__MultiArrayLayout__Sequence * array, size_t size)
{
  ...
  if (size) {
    array->data = (std_msgs__msg__MultiArrayLayout *)allocator.zero_allocate(
      size, sizeof(std_msgs__msg__MultiArrayLayout), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!std_msgs__msg__MultiArrayLayout__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          std_msgs__msg__MultiArrayLayout__fini(&array->data[j]);
        }
