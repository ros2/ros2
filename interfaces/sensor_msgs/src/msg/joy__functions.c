...
// sensor_msgs/msg/Joy functions implementation
...
bool sensor_msgs__msg__Joy__init(sensor_msgs__msg__Joy * msg)
{
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->axes, 0)) { return false; }
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->buttons, 0)) { return false; }
  return true;
}
...
sensor_msgs__msg__Joy * sensor_msgs__msg__Joy__create(void)
{
  ...
  sensor_msgs__msg__Joy * msg =
    (sensor_msgs__msg__Joy *)allocator.allocate(
      sizeof(sensor_msgs__msg__Joy), allocator.state);
  if (!msg) { return NULL; }
  if (!sensor_msgs__msg__Joy__init(msg)) {
  ...
  sensor_msgs__msg__Joy__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (sensor_msgs__msg__Joy *)allocator.zero_allocate(
      size, sizeof(sensor_msgs__msg__Joy), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!sensor_msgs__msg__Joy__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          sensor_msgs__msg__Joy__fini(&array->data[j]);
        }
