...
// nav_msgs/srv/SetMap_Response functions
...
nav_msgs__srv__SetMap_Response * nav_msgs__srv__SetMap_Response__create(void)
{
  ...
  nav_msgs__srv__SetMap_Response * msg = (nav_msgs__srv__SetMap_Response *)allocator.allocate(
    sizeof(nav_msgs__srv__SetMap_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  if (!nav_msgs__srv__SetMap_Response__init(msg)) {
  ...
  nav_msgs__srv__SetMap_Response__Sequence * array, size_t size)
{
  ...
  array->data = (nav_msgs__srv__SetMap_Response *)allocator.zero_allocate(
    size, sizeof(nav_msgs__srv__SetMap_Response), allocator.state);
  if (!array->data) {
    return false;
  }

  for (size_t i = 0; i < size; ++i) {
    if (!nav_msgs__srv__SetMap_Response__init(&array->data[i])) {
      for (size_t j = 0; j < i; ++j) {
        nav_msgs__srv__SetMap_Response__fini(&array->data[j]);
      }
