...
// rcl_interfaces/msg/FloatingPointRange functions
...
rcl_interfaces__msg__FloatingPointRange * rcl_interfaces__msg__FloatingPointRange__create(void)
{
  ...
  rcl_interfaces__msg__FloatingPointRange * msg = (rcl_interfaces__msg__FloatingPointRange *)allocator.allocate(
    sizeof(rcl_interfaces__msg__FloatingPointRange), allocator.state);
  if (!msg) {
    return NULL;
  }
  if (!rcl_interfaces__msg__FloatingPointRange__init(msg)) {
  ...
  rcl_interfaces__msg__FloatingPointRange__Sequence * array, size_t size)
{
  ...
  array->data = (rcl_interfaces__msg__FloatingPointRange *)allocator.zero_allocate(
    size, sizeof(rcl_interfaces__msg__FloatingPointRange), allocator.state);
  if (!array->data) {
    return false;
  }

  for (size_t i = 0; i < size; ++i) {
    if (!rcl_interfaces__msg__FloatingPointRange__init(&array->data[i])) {
      for (size_t j = 0; j < i; ++j) {
        rcl_interfaces__msg__FloatingPointRange__fini(&array->data[j]);
      }
