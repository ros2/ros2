...
// rcl_interfaces/srv/SetParametersAtomically type

#ifndef RCL_INTERFACES__SRV__SETPARAMETERSATOMICALLY_H_
#define RCL_INTERFACES__SRV__SETPARAMETERSATOMICALLY_H_
...
typedef struct rcl_interfaces__srv__SetParametersAtomically__Request
{
  rcl_interfaces__msg__Parameter__Sequence parameters;
} rcl_interfaces__srv__SetParametersAtomically__Request;

typedef struct rcl_interfaces__srv__SetParametersAtomically__Request__Sequence
{
  rcl_interfaces__srv__SetParametersAtomically__Request * data;
  size_t size;
  size_t capacity;
} rcl_interfaces__srv__SetParametersAtomically__Request__Sequence;
...
typedef struct rcl_interfaces__srv__SetParametersAtomically__Response
{
  rcl_interfaces__msg__SetParametersResult result;
} rcl_interfaces__srv__SetParametersAtomically__Response;

typedef struct rcl_interfaces__srv__SetParametersAtomically__Response__Sequence
{
  rcl_interfaces__srv__SetParametersAtomically__Response * data;
  size_t size;
  size_t capacity;
} rcl_interfaces__srv__SetParametersAtomically__Response__Sequence;
...
#endif  // RCL_INTERFACES__SRV__SETPARAMETERSATOMICALLY_H_
