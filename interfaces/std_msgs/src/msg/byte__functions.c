...
// std_msgs/msg/Byte functions implementation
...
std_msgs__msg__Byte * std_msgs__msg__Byte__create(void)
{
  ...
  std_msgs__msg__Byte * msg = (std_msgs__msg__Byte *)allocator.allocate(
    sizeof(std_msgs__msg__Byte), allocator.state);
  if (!msg) { return NULL; }
  if (!std_msgs__msg__Byte__init(msg)) {
  ...
  std_msgs__msg__Byte__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (std_msgs__msg__Byte *)allocator.zero_allocate(
      size, sizeof(std_msgs__msg__Byte), allocator.state);
