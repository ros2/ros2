...
// shape_msgs/msg/Plane functions
...
shape_msgs__msg__Plane * shape_msgs__msg__Plane__create(void)
{
  ...
  shape_msgs__msg__Plane * msg = (shape_msgs__msg__Plane *)allocator.allocate(
    sizeof(shape_msgs__msg__Plane), allocator.state);
  if (!msg) {
    return NULL;
  }
  if (!shape_msgs__msg__Plane__init(msg)) {
  ...
  shape_msgs__msg__Plane__Sequence * array, size_t size)
{
  ...
  array->data = (shape_msgs__msg__Plane *)allocator.zero_allocate(
    size, sizeof(shape_msgs__msg__Plane), allocator.state);
  if (!array->data) {
    return false;
  }

  for (size_t i = 0; i < size; ++i) {
    if (!shape_msgs__msg__Plane__init(&array->data[i])) {
      for (size_t j = 0; j < i; ++j) {
        shape_msgs__msg__Plane__fini(&array->data[j]);
      }
