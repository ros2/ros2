...
// std_msgs/msg/ByteMultiArray functions implementation
...
std_msgs__msg__ByteMultiArray * std_msgs__msg__ByteMultiArray__create(void)
{
  ...
  std_msgs__msg__ByteMultiArray * msg =
    (std_msgs__msg__ByteMultiArray *)allocator.allocate(
      sizeof(std_msgs__msg__ByteMultiArray), allocator.state);
  if (!msg) { return NULL; }
  if (!std_msgs__msg__ByteMultiArray__init(msg)) {
  ...
  std_msgs__msg__ByteMultiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    array->data = (std_msgs__msg__ByteMultiArray *)allocator.zero_allocate(
      size, sizeof(std_msgs__msg__ByteMultiArray), allocator.state);
    if (!array->data) { return false; }
    for (size_t i = 0; i < size; ++i) {
      if (!std_msgs__msg__ByteMultiArray__init(&array->data[i])) {
        for (size_t j = 0; j < i; ++j) {
          std_msgs__msg__ByteMultiArray__fini(&array->data[j]);
        }
