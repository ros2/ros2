...
// std_msgs/msg/Int32 functions implementation
...
std_msgs__msg__Int32 * std_msgs__msg__Int32__create(void)
{
  ...
  std_msgs__msg__Int32 * msg = (std_msgs__msg__Int32 *)allocator.allocate(
    sizeof(std_msgs__msg__Int32), allocator.state);
  if (!msg) { return NULL; }
  if (!std_msgs__msg__Int32__init(msg)) {
  ...
  std_msgs__msg__Int32__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (std_msgs__msg__Int32 *)allocator.zero_allocate(
      size, sizeof(std_msgs__msg__Int32), allocator.state);
