...
// rcl_interfaces/msg/IntegerRange functions
...
rcl_interfaces__msg__IntegerRange * rcl_interfaces__msg__IntegerRange__create(void)
{
  ...
  rcl_interfaces__msg__IntegerRange * msg = (rcl_interfaces__msg__IntegerRange *)allocator.allocate(
    sizeof(rcl_interfaces__msg__IntegerRange), allocator.state);
  if (!msg) {
    return NULL;
  }
  if (!rcl_interfaces__msg__IntegerRange__init(msg)) {
  ...
  rcl_interfaces__msg__IntegerRange__Sequence * array, size_t size)
{
  ...
  array->data = (rcl_interfaces__msg__IntegerRange *)allocator.zero_allocate(
    size, sizeof(rcl_interfaces__msg__IntegerRange), allocator.state);
  if (!array->data) {
    return false;
  }

  for (size_t i = 0; i < size; ++i) {
    if (!rcl_interfaces__msg__IntegerRange__init(&array->data[i])) {
      for (size_t j = 0; j < i; ++j) {
        rcl_interfaces__msg__IntegerRange__fini(&array->data[j]);
      }
