...
- `docs/permission/ROS2_SESSION_PERMISSION_ROOT_CAUSE.md` - 权限体系深度分析
- `docs/misc/SOFTBUS_CALLBACK_SEMANTICS.md` - 回调机制细节
- `docs/ohos/OPENHARMONY_GN_INTEGRATION_GUIDE.md` - 编译配置
- `docs/discovery/DISCOVERY_PROTOCOL_V3.1.md` - 协议规范
- 其他 + 原有文档
...
阅读文档路径:
1. `docs/phases/phase2/PHASE2_DOCUMENTATION_INDEX.md` - 文档导航 (5 min)
...
**推荐**: 详见 `docs/phases/phase2/PHASE2_DOCUMENTATION_INDEX.md` 了解完整文档体系。
