...
// geometry_msgs/msg/Point functions implementation
...
geometry_msgs__msg__Point * geometry_msgs__msg__Point__create(void)
{
  ...
  geometry_msgs__msg__Point * msg =
    (geometry_msgs__msg__Point *)allocator.allocate(
      sizeof(geometry_msgs__msg__Point), allocator.state);
  if (!msg) { return NULL; }
  if (!geometry_msgs__msg__Point__init(msg)) {
  ...
  geometry_msgs__msg__Point__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (size) {
    array->data = (geometry_msgs__msg__Point *)allocator.zero_allocate(
      size, sizeof(geometry_msgs__msg__Point), allocator.state);
